...
# -----
# Mirror of https://github.com/thanos-io/thanos/blob/main/scripts/busybox-updater.sh
# @ 613a003116eea24612f21b4c7af6a7eef0a5c7c6
#
# On thanos-parquet-gateway it is NOT run by an automatic github workflow currently.
# -----
